...
dag = DAG(
    ...
    start_date=dt.datetime(2022, 2, 19, 21, 30, 00)
)
...
def take_event(**context):
    ...
    #path_to_activity = path.abspath(path.join('DAG.py', "../last_100_events/{}.json".format(last_cme['activityID'])))
...
path_to_dashapp = path.abspath(path.join('DAG.py', "../dashapp.py"))
